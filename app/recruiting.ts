...
export const RECRUITING_TARGET_SEEDS: RecruitingTargetSeed[] = [
  ...
  },
  {
    ...
    workMode: "Remote regional team",
    discoveredOn: "2026-08-08",
    verifiedOn: "2026-08-08",
    timezone: "America/Chicago",
    initialStatus: "Open",
    publishedDeadline: "2026-09-11",
    deadlineTimezone: "America/New_York",
    compensationEvidence: "Compensation is not established on the official application page.",
    roleScope: "Find founders, evaluate companies, make investment decisions, and participate in weekly regional meetings for 10–15 hours per week.",
    qualificationReason: "Unusually real student investment ownership, but an Investing Milestone that must replace Lab hours rather than stack on top.",
    immigrationState: "Unknown",
    immigrationEvidence: "International students at U.S. or Canadian colleges are eligible; the page does not establish employment or CPT requirements.",
    authorizationClaim: false,
    nextAction: "Complete the explicit time-substitution decision before preparing an application.",
    dueDate: "2026-08-15",
  },
  {
