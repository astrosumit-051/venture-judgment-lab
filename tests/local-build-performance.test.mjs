...
for (const lazySurface of ["app/ConversationTeacher.tsx", "app/AdvancedFormsView.tsx", "app/DailyAssignmentView.tsx", "app/HistoryView.tsx"]) {
...
console.log(`Local build performance passed: eager Lab shell ${(appBytes / 1024).toFixed(1)} KiB; chat-first workspace ${(workspaceBytes / 1024).toFixed(1)} KiB with four view-loaded modules.`);
